"""Create a method to the AVLTree class that prints
out the elements using a depth-first post order
tree traversal"""
...
class AVLTree(object):
    ...
    #This method prints the elements using a depth-first post order tree traversal
...
def main():
    ...
    #Prints the elements using a depth-first post order tree traversal
